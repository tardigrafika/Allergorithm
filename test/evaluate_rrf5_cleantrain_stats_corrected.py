...
RAW_RESULTS = Path("/home/lana/ALERGRAF/test/evaluation_results_raw_rrf5_cleantrain.json")
SUMMARY_OUTPUT = Path("/home/lana/ALERGRAF/test/evaluate_rrf5_cleantrain_stats_corrected_summary.txt")
SEED = 42
N_PERM = 10000
