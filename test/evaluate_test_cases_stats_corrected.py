...
RAW_RESULTS = Path("/home/lana/ALERGRAF/test/evaluation_results_raw.json")
SUMMARY_OUTPUT = Path("/home/lana/ALERGRAF/test/evaluation_stats_corrected_summary.txt")
SEED = 42
N_PERM = 10000
